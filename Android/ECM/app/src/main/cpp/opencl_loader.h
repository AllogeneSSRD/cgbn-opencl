...
constexpr cl_int CL_BUILD_IN_PROGRESS = -12;
constexpr cl_int CL_BUILD_ERROR = -11;
...
constexpr cl_int CL_INVALID_BINARY = -42;
constexpr cl_int CL_INVALID_PROGRAM = -44;
constexpr cl_int CL_INVALID_KERNEL = -48;
constexpr cl_int CL_INVALID_OPERATION = -59;
