// AUTO-GENERATED by tools/gen_mp_addmod_asm_block64.py — do not edit.
...
// 64-limb fused add-mod block; streaming __global (4096-bit unroll).
static inline void asm_fused_block64(__global const uint *a, __global const uint *b,
